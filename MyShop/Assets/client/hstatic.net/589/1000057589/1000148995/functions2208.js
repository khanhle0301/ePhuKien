...
var ega = function () {
	...
	var lazyLoad = function() {
		var lazyLoadEl = $('[data-lazyload-pd]');
		if( lazyLoadEl.length > 0 ) {
			lazyLoadEl.each( function(){
				var element = $(this),
						elementImg = element.attr( 'data-lazyload-pd' );

				element.attr( 'src', 'http://hstatic.net/589/1000057589/1000148995/blank.svg?v=251' ).css({ 'background': 'url(http://hstatic.net/589/1000057589/1000148995/preloader.gif?v=251) no-repeat center center #FFF' });
